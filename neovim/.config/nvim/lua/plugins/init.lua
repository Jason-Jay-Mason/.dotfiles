...
local plugins = function(use)
  ...
  -- Buffers as tabs
  use { 'akinsho/bufferline.nvim', config = function() require 'plugins.config.bufferline' end, after =
  'nvim-web-devicons' }
  -- Navigation tree
  ...
  use { "windwp/nvim-autopairs", config = function() require 'plugins.config.autopairs' end, event = 'BufWinEnter' }
  -- Auto close tag
  use { "windwp/nvim-ts-autotag", event = 'BufWinEnter' }
  -- Comments
  use { "numToStr/Comment.nvim", config = function() require 'plugins.config.comment' end, event = 'BufWinEnter' }
  use { "folke/todo-comments.nvim", config = function() require 'plugins.config.todocomments' end, event = 'BufWinEnter' }
  -- Git
  use { 'lewis6991/gitsigns.nvim', config = function() require 'plugins.config.gitsigns' end, event = 'BufWinEnter' }
  -- Live code server
